...
?>
	...
	<body>
       ...
       <button class = "classname1" >History</button></a><br>
        ...
        <input type="checkbox" id="<?php echo 'read'.$rows['form_id']?>" value="true" name="read"> Mark As Read<br>
         <input type="checkbox" id="<?php echo 'reply'.$rows['form_id']?>" value="true" name="reply"> Reply<br>
        </div>
         </div>
	</body>
</html>
