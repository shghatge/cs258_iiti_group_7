...
<html>
	...
	<body>
		...
		<table align="center" width = "700">
			...
			<tr>
				<td width = "80" height = "50" ><p class = "ffour">Security Question*</p></td>
				<td width = "7">:</td>
				<td><select name="securityques">
				...
				<td width = "80" height = "50" ><p class = "ffive">Security Answer*</p></td>
				<td width = "7">:</td>
				<td width = "300"><input name="securityans" type="text" id="securityans" size="35"  required></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td></td>
				<td><p class = "twelve" align = "right" color = "RED">(*) mandatory fields</p></td>
		</table> 
		</form>
	</body>
</html>