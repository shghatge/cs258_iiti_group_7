...
<input type="button" onclick="FunctionInput2(1)" id="h2" value="Delete" />
...
<input type="button" onclick="FunctionInput2(2)" id="ha2" value="Delete" />
...
<input type="button" onclick="FunctionInput2(3)" id="hah2" value="Delete" />
...
<input type="button" onclick="FunctionInput(4)" id="hahe" value="Add new" />
<input type="button" onclick="FunctionInput2(4)" id="hahe2" value="Delete" />
...
<input type="button" onclick="FunctionInput(5)" id="hahu" value="Add new" />
<input type="button" onclick="FunctionInput2(5)" id="hahu2" value="Delete" />
...
<input type="button" onclick="FunctionInput(6)" id="hahy" value="Add new" />
<input type="button" onclick="FunctionInput2(6)" id="hahy2" value="Delete" />
...
<input type="button" onclick="FunctionInput(7)" id="haht" value="Add new" />
<input type="button" onclick="FunctionInput2(7)" id="haht2" value="Delete" />
